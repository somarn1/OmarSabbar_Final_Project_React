...
function Blog() {
  ...
  const bgImg = {
    backgroundImage: `url(${images.Items.Item7})`,
        ...
        <div>
            ...
            <div className="container mx-auto px-4 py-8 md:py-12">
                ...
                <div className="relative h-32 md:h-40 mb-12 overflow-hidden rounded-lg bg-gray-800">
                    <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center " style={bgImg}>
